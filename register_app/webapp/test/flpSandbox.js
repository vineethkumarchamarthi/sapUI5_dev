		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comdemoregisterapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemoregisterapp-display": {
								"semanticObject": "comdemoregisterapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.registerapp",
									"url": sap.ui.require.toUrl("com/demo/registerapp")
								}
							}
						}
					}
